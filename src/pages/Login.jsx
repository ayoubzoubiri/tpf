        ...
        <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-2xl p-8">
                    ...
                    <p className="text-slate-500 text-center text-sm mb-6">Sign in to continue planning your trips</p>
                    ...
                    {/* Google Button */}
                    <button className="w-full py-3 px-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl transition flex items-center justify-center gap-3 font-medium text-slate-700 mb-4">
